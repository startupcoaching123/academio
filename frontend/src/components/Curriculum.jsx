...
const Curriculum = () => {
    ...
    return (
        <section className="py-12 md:py-10 bg-slate-50 overflow-hidden relative selection:bg-teal-100 selection:text-teal-900">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="lg:grid lg:grid-cols-2 lg:gap-24 items-center">
                    ...
                    <div className="relative lg:h-[600px] flex items-center justify-center hidden lg:block">
                        <CompositionVisual />
                    </div>
                </div>
            </div>
